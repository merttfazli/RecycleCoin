...
namespace RecycleCoin
{
    public partial class KullaniciBilgiGuncelleme : Form
    {
        ...
        private void btn_Guncelle_Click(object sender, EventArgs e)
        {
            ...
            if (kul.KullaniciBilgiGuncelleme(kul,Anasayfa.id))
            {
                dialog = MessageBox.Show("Bilgileriniz Güncellendi Başka Bir İşlem Yapmak İstiyor Musunuz? ","Bilgilendirme",MessageBoxButtons.YesNo);
